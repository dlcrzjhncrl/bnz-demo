###Transfer Page###
Transfer_From_Button = '//div[@data-testid="PaymentModal"]//button[@data-testid="from-account-chooser"]'
Transfer_To_Button = '//div[@data-testid="PaymentModal"]//button[@data-testid="to-account-chooser"]'
...
Transfer_TransferPayment_Modal = '//div[@data-testid="PaymentModal"]'
Transfer_Modal_From_Label = '//h2//span[text()="From"]'
Transfer_Modal_To_Label = '//h2//span[text()="To"]'
Transfer_TransferSuccess_Notification = '//div[@id="notification"]//span[@role="alert" and text()="Transfer successful"]'
